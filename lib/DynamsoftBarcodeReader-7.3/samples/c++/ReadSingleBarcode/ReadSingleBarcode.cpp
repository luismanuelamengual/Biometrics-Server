...
int DecodeFile(CBarcodeReader& reader,const char* pszImageFile,int  iBarcodeFormat,float& fCostTime)
{
	...
	tempParam.barcodeFormatIds = iBarcodeFormat;
    char error[1024] ={0};
...
int main(int argc, const char* argv[])
{
	...
	iRet = reader.InitLicense("t0068NQAAAKfeKkb7B24m1zOhwuszMrYrqLHSetCPGKgTk0uIX3zSqXM3qUk53NJA7Qs6Mt2sj281jkuBC30LOVYr1zXLyjE=");
