...
void OutputResult(CBarcodeReader& reader,int errorcode,float time)
{
	...
	if (iRet != DBR_OK && iRet != DBRERR_MAXICODE_LICENSE_INVALID && iRet != DBRERR_GS1_COMPOSITE_LICENSE_INVALID && iRet != DBRERR_LICENSE_EXPIRED && iRet != DBRERR_QR_LICENSE_INVALID &&
		iRet != DBRERR_1D_LICENSE_INVALID && iRet != DBRERR_PDF417_LICENSE_INVALID && iRet != DBRERR_DATAMATRIX_LICENSE_INVALID && iRet !=DBRERR_AZTEC_LICENSE_INVALID && iRet != DBRERR_GS1_DATABAR_LICENSE_INVALID && iRet != DBRERR_PATCHCODE_LICENSE_INVALID )
	{
...
int main(int argc, const char* argv[])
{
	...
	reader.InitLicense("t0068NQAAAGCAxHty93oaSv+Le46rIyT4uoMoP5ccVmK9bZGjitLYBvmv4icw2CXOjMFc2rO8afC7a3Kqc/x2VVu2obUoN28=");
